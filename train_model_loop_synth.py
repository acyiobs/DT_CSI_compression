...
if __name__ == "__main__":
    ...
    synth_data_root = "DeepMIMO/DeepMIMO_datasets/Boston5G_3p5_notree_mid_res"
    ...
    for i in range(10):
        ...
        print(all_avg_nmse)
        savemat(
            os.path.join(output_dir, "all_avg_nmse_train_on_mid_res_synth.mat"),
            {"all_avg_nmse_train_on_synth": np.stack(all_avg_nmse, 0)},
        )
