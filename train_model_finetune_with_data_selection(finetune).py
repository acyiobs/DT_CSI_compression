...
if __name__ == "__main__":
    ...
    for num_train_data in [10, 20, 40, 80, 160, 320, 640, 1280, 2560, 5120]:
        ...
        train_loader = DataLoader(
            DataFeed(real_data_root, train_csv, num_data_point=5120), batch_size=train_batch_size, shuffle=True
        )
        ...
        finetune_loader = DataLoader(finetune_real_dataset, batch_size=train_batch_size, shuffle=True)
    ...
    print(all_nmse)
    savemat(
        "result_new_data_1/all_nmse_finetune_select.mat",
