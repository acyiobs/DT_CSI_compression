...
ylabel('NMSE (dB)');
legend('Train on real', 'Train on synth', 'Finetune on random real (pretrain on 5k synth data points)', 'Augment with random real (pretrain on 5k synth data points)', 'Augment with selected real (pretrain on 5k synth data points)');
